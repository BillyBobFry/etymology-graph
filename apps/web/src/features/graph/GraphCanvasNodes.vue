...
const rootGraphNodeCircleClass =
    ...
    >
      <circle
        :class="[
          ...
          node.id === rootNodeId && rootGraphNodeCircleClass,
        ...
        :r="graphNodeRadius"
      />
      <text :class="graphNodeTextClass" :font-size="graphNodeWordFontSize" :y="graphNodeRadius + 18" text-anchor="middle">
        {{ node.word }}
      </text>
      <text :class="graphNodeLanguageTextClass" :font-size="graphNodeMetaFontSize" :y="graphNodeRadius + 34" text-anchor="middle">
